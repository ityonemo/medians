defmodule MediansWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(MediansWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(MediansWeb.Gettext, "errors", msg, opts)
    end
  end
