defmodule MediansWeb.SchoolController do
  ...
  @stat_assignments Map.new(~w(L75 L50 L25 G75 G50 G25 gre75v gre50v gre25v gre75q gre50q gre25q gre75w gre50w gre25w)a, fn atom -> {Atom.to_string(atom), atom} end)
